...
public class Manager : MonoBehaviour
{
    ...
    protected string[] toys = {"Bear", "Monkey", "Penguin", "Pig", "Rabbit", "Sheep"};
    ...
    protected virtual void Spawn(string item, Vector3 pos = default)
    {
        int randomX = Random.Range(-7, 7);
        int randomY = Random.Range(10, 12);
        pos = new Vector3(randomX, randomY, 0f);
        GameObject newCoin = (GameObject)objectPooler.SpawnFromPool(item, pos, Quaternion.Euler(0, 0, 90));
